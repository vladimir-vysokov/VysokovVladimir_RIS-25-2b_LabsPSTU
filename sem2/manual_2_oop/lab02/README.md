...
- При явном отсутствии конструкторов, компилятор создает конструктор по умолчанию, однако он не сможет создать
констатные или ссылочные поля (ошибка).
- Не наследуются
...
## Иллюстрации
- Диаграмма: Salary: ![Диаграмма: Salary](salary.drawio.png)
